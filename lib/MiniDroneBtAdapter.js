...
class MiniDroneBtAdapter extends EventEmitter {
    ...
    writeMaxAltitude(altitude) {
        ...
        buffer.fill(0);
        buffer.writeInt8(2, 0);                                     //dataType (1:ACK,2:Data_NO_ACK,3:LOW_LATENCY_DATA,4:DATA_WITH_ACK)
        buffer.writeInt8(++this.steps[FLIGHT_PARAMS_KEY], 1);       //step
        buffer.writeInt8(2, 2);                                     //project (0:COMMON,1:ARDRONE3,2:MINIDRONE)
        buffer.writeInt8(MD_CLASSES.PILOTING_SETTINGS, 3);          //class (see:https://github.com/Parrot-Developers/arsdk-xml/blob/master/xml/minidrone.xml)
        buffer.writeInt8(MD_METHODS.MAX_ALTITUDE, 4);               //command (see:https://github.com/Parrot-Developers/arsdk-xml/blob/master/xml/minidrone.xml)
        buffer.writeInt8(0, 5);                                     //empty ?
    ...
    writeMaxTilt(tilt) {
        ...
        buffer.writeInt8(2, 2);                                     //project (0:COMMON,1:ARDRONE3,2:MINIDRONE)
        buffer.writeInt8(MD_CLASSES.PILOTING_SETTINGS, 3);          //class (see:https://github.com/Parrot-Developers/arsdk-xml/blob/master/xml/minidrone.xml)
        buffer.writeInt8(MD_METHODS.MAX_TILT, 4);                   //command (see:https://github.com/Parrot-Developers/arsdk-xml/blob/master/xml/minidrone.xml)
        buffer.writeInt8(0, 5);                                     //empty ?
    ...
    writeMaxVerticalSpeed(verticalSpeed) {
        ...
        buffer.writeInt8(++this.steps[FLIGHT_PARAMS_KEY], 1);       //step
        buffer.writeInt8(2, 2);                                     //project (0:COMMON,1:ARDRONE3,2:MINIDRONE)
        buffer.writeInt8(MD_CLASSES.SPEED_SETTINGS, 3);             //class (see:https://github.com/Parrot-Developers/arsdk-xml/blob/master/xml/minidrone.xml)
        buffer.writeInt8(MD_METHODS.MAX_VERTICAL_SPEED, 4);         //command (see:https://github.com/Parrot-Developers/arsdk-xml/blob/master/xml/minidrone.xml)
        buffer.writeInt8(0, 5);                                     //empty ?
    ...
    writeMaxRotationSpeed(rotationSpeed) {
        ...
        buffer.writeInt8(2, 2);                                     //project (0:COMMON,1:ARDRONE3,2:MINIDRONE)
        buffer.writeInt8(MD_CLASSES.SPEED_SETTINGS, 3);             //class (see:https://github.com/Parrot-Developers/arsdk-xml/blob/master/xml/minidrone.xml)
        buffer.writeInt8(MD_METHODS.MAX_ROTATION_SPEED, 4);         //command (see:https://github.com/Parrot-Developers/arsdk-xml/blob/master/xml/minidrone.xml)
        buffer.writeInt8(0, 5);                                     //empty ?
