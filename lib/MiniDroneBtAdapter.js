                    ...
                    case 5:         // SpeedSettingsState
                        switch (commandKey)
                        {
                            case 0: // MaxVerticalSpeedChanged
                                Logger.debug(`MaxVerticalSpeedChanged : current= ${data.readFloatLE(6)} - min=${data.readFloatLE(10)} - max=${data.readFloatLE(14)}`);
                            break;
                            case 1: // MaxRotationSpeedChanged
                                Logger.debug(`MaxRotationSpeedChanged : current= ${data.readFloatLE(6)} - min=${data.readFloatLE(10)} - max=${data.readFloatLE(14)}`);
                            break;
                            default:
                                Logger.info("Packet implementation missing : dataType:" + dataType + " | project:" + project + " | class:" +  msgClass + " | command:" +  commandKey);
                            break;
                    ...
                    case 9:         // PilotingSettingsState
                        switch (commandKey)
                        {
                            case 0: // MaxAltitudeChanged
                                Logger.debug(`MaxAltitudeChanged : current= ${data.readFloatLE(6)} - min=${data.readFloatLE(10)} - max=${data.readFloatLE(14)}`);
                            break;
                            case 1: // MaxTiltChanged
                                Logger.debug(`MaxTiltChanged : current= ${data.readFloatLE(6)} - min=${data.readFloatLE(10)} - max=${data.readFloatLE(14)}`);
                            break;
                            default:
                                Logger.info("Packet implementation missing : dataType:" + dataType + " | project:" + project + " | class:" +  msgClass + " | command:" +  commandKey);
                            break;
