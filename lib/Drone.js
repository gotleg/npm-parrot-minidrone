...
class Drone extends EventEmitter {
     ...
     * @param {String} options.droneFilter The name of the drone to restrict connection to (you can use RegExp)
     ...
     *
     * @param {Float} altitude Increase or decrease the max altitude 0.5 to 10
     * @return {undefined}
     */
    ...
    connect() {
        ...
        /**
         * Fires when the Drone disconnected
         *
         * @event Drone#disconnected
         * @type {object}
         */
        this.network.on('disconnected', (...args) => this.emit('disconnected', ...args));
        ...
        this.network.on('batteryStatusChange', (...args) => this.emit('batteryStatusChange', ...args));
         ...
         /**
         * Fires when the drone's alert state has changed
         *
         * @event Drone#alertStateChange
         * @type {object}
         */
        this.network.on('alertStateChange', (...args) => this.emit('alertStateChange', ...args));

        /**
         * Fires when the drone's speed has changed
         *
         * @event Drone#droneSpeed
         * @type {object}
         */
        this.network.on('droneSpeedChange', (...args) => this.emit('droneSpeedChange', ...args));

        /**
         * Fires when the drone's position has changed
         *
         * @event Drone#dronePosition
         * @type {object}
         */
        this.network.on('dronePositionChange', (...args) => this.emit('dronePositionChange', ...args));
         ...
         */
         ...
         /**
          * Fires when poweredOff state is received from noble
          *
          */
          this.network.on('poweredOff', (...args) => this.emit('poweredOff', ...args));
